"""
Blur tool functions using MediaPipe for precise face detection
"""
import cv2
import numpy as np
...
def blur_image(
    ...
    if mode == "auto":
        # Use MediaPipe Face Mesh for precise face detection (468 landmarks)
...
def detect_faces(image_bytes: bytes) -> List[Tuple[int, int, int, int]]:
    """
    Detect faces in an image using MediaPipe Face Mesh (468 landmarks).
